...
<body>
  ...
  <div class="container">
    <div class="main">
      <a href="addslider.php" style="background-color: #007bff; padding: 10px;"><i class="fa fa-plus-circle" style="color: #fff;">Thêm slider</i></a>
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ?> <tr>
              ...
              <td>
                <a href="edit-slide.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" style="color: ;"></i></a>
              </td>
              <td>
              <a class="btn" onclick="confirmDelete();" href="proces-del-slide.php?id=<?php echo $row['id']; ?>" ><i class="fa fa-trash" style="color: red;"></i></a>
              </td>
            </tr>
          <?php
          }
  ...
  <script src="js/cf-del-slide.js"></script>
</body>
